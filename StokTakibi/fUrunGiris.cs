    ...
    public partial class fUrunGiris : Form
    {
        ...
        private void bKaydet_Click(object sender, EventArgs e)
        {
            if (tBarkod.Text != "" && tUrunAdi.Text != "" && cmbUrunGrubu.Text != "" && tAlisFiyati.Text != "" && tSatisFiyati.Text != "" && tKdvOrani.Text != "" && tMiktar.Text != "")
            {
                ...
                Islemler.StokHareket1(tBarkod.Text, "Adet", Convert.ToDouble(tMiktar.Text), cmbUrunGrubu.Text,lKullanici.Text);
                Temizle();
            }
            else
            {
        ...
        private void silToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (gridUrunler.Rows.Count > 0)
            {
                ...
                DialogResult onay = MessageBox.Show(urunad + "ürünü silmek istiyor musunsunuz?", "Ürün silme işlemi", MessageBoxButtons.YesNo);
        ...
        {
            DialogResult onay = MessageBox.Show("!! Lütfen Dikkat : \n Ürün Fiyat Düzenlemelerinin TAMAMINI Yaptıysanız Bu İşlemi Onaylayınız", "Dikkat - Kullanılmayan Ürün Silme İşlemi", MessageBoxButtons.YesNo);
            if (onay==DialogResult.Yes)
            {
